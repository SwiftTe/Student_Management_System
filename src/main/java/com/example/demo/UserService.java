...
import java.util.regex.Pattern; // Not used in this file but was in original, kept for consistency
...
public class UserService {
    ...
    public List<User> getAllUsers() throws SQLException {
        // This line correctly calls getAllUsers() which should be defined in UserDAO
